...
const translations = {
  uk: {
    ...
    stepsTitle: "Так, тут можна отримати підтримку. Ні, це не працює як банкомат. Ми допоможемо зрозуміти, чи є у вашій ситуації реальний шанс, що саме варто пробувати і де краще не витрачати нерви. Мінімальний вхід - максимум ясності. Далі вже вирішуєте, чи гра варта свічок.",
    steps: [
  ...
  en: {
    ...
    stepsTitle: "Yes, support may be available here. No, it does not work like an ATM. We help you understand whether your situation has a real chance, what is worth trying and where it is better not to waste your nerves. Minimum entry - maximum clarity. Then you decide whether it is worth the effort.",
...
Object.assign(translations, {
  es: {
    ...
    stepsTitle: "Sí, aquí se puede obtener apoyo. No, no funciona como un cajero automático. Te ayudamos a entender si tu situación tiene una posibilidad real, qué merece la pena intentar y dónde es mejor no gastar nervios. Entrada mínima - máxima claridad. Después decides si vale la pena.",
  ...
  fr: {
    ...
    stepsTitle: "Oui, il est possible d'obtenir un soutien ici. Non, cela ne fonctionne pas comme un distributeur automatique. Nous vous aidons à comprendre si votre situation a une chance réelle, ce qu'il vaut la peine d'essayer et où il vaut mieux ne pas perdre vos nerfs. Entrée minimale - clarté maximale. Ensuite, vous décidez si cela en vaut la peine.",
  ...
  de: {
    ...
    stepsTitle: "Ja, hier kann Unterstützung möglich sein. Nein, es funktioniert nicht wie ein Geldautomat. Wir helfen Ihnen zu verstehen, ob Ihre Situation eine echte Chance hat, was sich zu versuchen lohnt und wo Sie besser keine Nerven verschwenden. Minimaler Einstieg - maximale Klarheit. Danach entscheiden Sie, ob sich der Aufwand lohnt.",
  ...
  pl: {
    ...
    stepsTitle: "Tak, tutaj można uzyskać wsparcie. Nie, to nie działa jak bankomat. Pomożemy zrozumieć, czy w Twojej sytuacji jest realna szansa, czego warto próbować i gdzie lepiej nie tracić nerwów. Minimalny próg wejścia - maksimum jasności. Potem decydujesz, czy gra jest warta świeczki.",
  ...
  ru: {
    ...
    stepsTitle: "Да, здесь можно получить поддержку. Нет, это не работает как банкомат. Мы поможем понять, есть ли в вашей ситуации реальный шанс, что именно стоит пробовать и где лучше не тратить нервы. Минимальный вход - максимум ясности. Дальше вы решаете, стоит ли игра свеч.",
